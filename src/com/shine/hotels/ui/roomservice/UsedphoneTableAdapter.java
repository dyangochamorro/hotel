...
public class UsedphoneTableAdapter extends BaseAdapter {
	private Context context;
	private List<TableRow> table;
	public UsedphoneTableAdapter(Context context, List<TableRow> table) {
		...
		public TableRowView(Context context, TableRow tableRow) {
			...
			for (int i = 0; i < tableRow.getSize(); i++) {//逐个格单元添加到行
				...
				if (0==i) {
					...
					//textCell.setTextColor(R.color.changyongdianhua_text);
