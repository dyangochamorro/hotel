...
public class HotelClock extends View {
    ...
    public HotelClock(Context context, AttributeSet attrs,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.HotelClock);
		 ...
		 * 初始化表盘，时针，分针， 秒针
		 */
		mDialDrawable = (BitmapDrawable) a.getDrawable(R.styleable.HotelClock_dialDrawable);
		//(BitmapDrawable) getResources().getDrawable(R.drawable.clock_left);
		mDial = mDialDrawable.getBitmap();
		
		mHourHandDrawable = (BitmapDrawable) a.getDrawable(R.styleable.HotelClock_hourDrawable);//getResources().getDrawable(R.drawable.clock_left_hour);
		
		mMinuteHandDrawable = (BitmapDrawable) a.getDrawable(R.styleable.HotelClock_minuteDrawable);//getResources().getDrawable(R.drawable.clock_left_min);
		
		mSecondHandDrawable = (BitmapDrawable) a.getDrawable(R.styleable.HotelClock_secondDrawable);//getResources().getDrawable(R.drawable.clock_left_second);
