...
public class CarrentalTableAdapter extends BaseAdapter {
	private Context context;
	private List<TableRow> table;
	public CarrentalTableAdapter(Context context, List<TableRow> table) {
	...
	class TableRowView extends LinearLayout {
		public TableRowView(Context context, TableRow tableRow) {
			...
			for (int i = 0; i < tableRow.getSize(); i++) {//逐个单元格添加到行
				...
				textCell.setTextColor(Color.rgb(222, 213, 182));
