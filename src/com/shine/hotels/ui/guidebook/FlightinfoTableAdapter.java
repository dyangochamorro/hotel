...
public class FlightinfoTableAdapter extends BaseAdapter {
	private Context context;
	private List<TableRow> table;
	public FlightinfoTableAdapter(Context context, List<TableRow> table) {
	...
	class TableRowView extends LinearLayout {
		public TableRowView(Context context, TableRow tableRow, int position) {
			...
			for (int i = 0; i < tableRow.getSize(); i++) {//逐个单元格添加到行
				...
				layoutParams.setMargins(2, 2, 2, 2);//预留空隙制造边框
